...
<%--													<label for="employeeId" class="col-sm-2 control-label">员工姓名</label>--%>
												<div class="col-sm-10">
													<select class="select2_demo_1 form-control "
...
<%--												<label for="date1" class="col-sm-2 control-label">开始日期</label>--%>
...
<%--												<label for="date2" class="col-sm-2 control-label">结束日期</label>--%>
												<div class="input-group date">
													<span class="input-group-addon"> <i
														class="fa fa-calendar"></i>
													</span> <input type="text" class="form-control"
...
<%--																	添加的工资统计--%>
																		<tfoot>
																		<tr>
<%--																			<td colspan="4"></td> <!-- 空白单元格，用于补齐前几列 -->--%>
																			<td>薪资等级:<td>
																			<td>${employeeRank}</td>
																			<td>累计:</td>
																			<td>${totalSalary}</td>
<%--																			<td th:text="${salarySelectForm.totalSalary}"></td> <!-- 显示 totalSalary -->--%>
																		</tr>
																		</tfoot>
