...
//
//		Long employeerank = employeesService.selectRankByEmployeeId(employeeId);
//		model.addAttribute("employeerank", employeerank);
...
//		System.out.println(empAll);
	...
	public String update(@PathVariable("id") Long employeeId ,FixedSalarysForm form, Model model, @RequestParam("newRank") Long newRank, @RequestParam("newRank") Long newTrueSalary) {
		//System.out.println(form.getFixedSalaryId());

		System.out.println(newRank);
		//新添加的修改薪资等级
		Map<String, Long> paramMap = new HashMap<>();
		paramMap.put("newRank", newRank);
		paramMap.put("employeeId", employeeId);

//		Map<String, Long> paramMap2 = new HashMap<>();
//		paramMap.put("newTrueSalary", newTrueSalary);
//		paramMap.put("employeeId", employeeId);
//
//		boolean resultTrueSalary = salarySettlementService.updateTrueMoneyByEmployeeId(paramMap2);
//		if(resultTrueSalary==true){
//			System.out.println("0000000000000000000");
//		}

		boolean resultrank = employeesService.updateEmployeeRank(paramMap);
		if(resultrank){
...
//		boolean result = fixedSalaryService.updateByEmployeeId(employeeId, form);
