								...
								<div class="ibox float-e-margins">
									...
									<div class="ibox-content">
										<form
											...
											<!-- 新添加的修改薪资等级 -->
											<div class="form-group">
												<label class="col-sm-2 control-label">新的薪资等级</label>
												<div class="col-sm-10">
													<input type="text" name="newRank" id="newRank" class="form-control" placeholder="输入新的薪资等级">
												</div>
											</div>
											<div class="hr-line-dashed"></div>

											<!-- 新添加的隐藏字段 -->
											<input type="hidden" name="newRank" id="hiddenNewRank" value="">
...
<%--											<div class="form-group">--%>
<%--												<div class="col-sm-3 col-sm-offset-2">--%>
<%--													<button class="btn btn-primary demo3" id="updateSalaryBtn" type="button">修改工资数值</button>--%>
<%--												</div>--%>
<%--												<div class="col-sm-3">--%>
<%--													<button class="btn btn-primary demo3" id="updateRankBtn" type="button">修改薪资等级</button>--%>
<%--												</div>--%>
<%--											</div>--%>
